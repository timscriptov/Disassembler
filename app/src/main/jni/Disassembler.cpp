...
JNIEXPORT jstring JNICALL Java_com_mcal_disassembler_nativeapi_DisassemblerDumper_getNameAt(JNIEnv *env, jclass type,
                                                                                            jlong pos)
{
	return env->NewStringUTF(disassemblerSymbolsList[pos].name.c_str());
}
JNIEXPORT jstring JNICALL Java_com_mcal_disassembler_nativeapi_DisassemblerDumper_getDemangledNameAt(JNIEnv *env, jclass type,
                                                                                                     jlong pos)
{
...
JNIEXPORT jint JNICALL Java_com_mcal_disassembler_nativeapi_DisassemblerDumper_getTypeAt(JNIEnv *env, jclass type,
                                                                                          jlong pos)
{
	return (jint)((int)disassemblerSymbolsList[pos].type);
}
JNIEXPORT jint JNICALL Java_com_mcal_disassembler_nativeapi_DisassemblerDumper_getBindAt(JNIEnv *env, jclass type,
                                                                                          jlong pos)
{
