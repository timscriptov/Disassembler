...
import com.mcal.disassembler.databinding.MainBinding

class Main : BaseActivity() {
    private val binding by lazy(LazyThreadSafetyMode.NONE) { MainBinding.inflate(layoutInflater) }
    ...
    fun toNameDemangler(view: View?) {
        startActivity(Intent(this, NameDemanglerActivity::class.java))
    }
